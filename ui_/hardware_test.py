from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QPushButton, 
                            QLabel, QComboBox, QSpinBox, QProgressBar, QGroupBox, 
...
class HardwareTestModule(QWidget):
    ...
    def __init__(self):
        ...
        self.current_time_utc = "2025-03-02 19:37:57"
        self.test_results = {}
        self.init_ui()
    ...
    def start_sensor_test(self):
        ...
        self.sensor_timer.timeout.connect(lambda: self.update_sensor_data(sensor))
        self.sensor_timer.start(1000)  # Her saniye